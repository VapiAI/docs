...
<CardGroup cols={2}>
  <Card
    ...
    icon="link"
    iconType="duotone"
    href="/server-url/setting-your-server-url"
  >
    Server URLs can be set in multiple places. Learn where here.
  </Card>
  <Card title="Developing Locally" icon="laptop-arrow-down" iconType="duotone" href="/server-url">
    Learn how you can receive events locally for testing & development.
  </Card>
...
<AccordionGroup>
  <Accordion title="What is a URL?">
    "URL" stands for "Uniform Resource Locator", it essentially allows Vapi to have a location on
    the Internet that it can drop data to & converse with your application via HTTP(S).
  </Accordion>
