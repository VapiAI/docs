...
<CardGroup cols={2}>
  <Card
    ...
    icon="route"
    iconType="solid"
    href="/learn/billing/cost-routing"
  >
  ...
  <Card title="Billing Limits" icon="meter" iconType="solid" href="/learn/billing/billing-limits">
    Learn how to set billing limits for your account.
  </Card>
  <Card title="Billing Examples" icon="books" iconType="solid" href="/learn/billing/examples">
