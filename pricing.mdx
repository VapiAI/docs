...
<CardGroup cols={2}>
  <Card title="Routing Provider Cost" icon="route" iconType="solid" href="/learn/billing/overview">
    Learn more about how Vapi bills & routes provider costs.
  </Card>
  <Card title="Billing Overview" icon="route" iconType="solid" href="/learn/billing/overview">
    Learn more about how Vapi bills & routes provider costs.
  </Card>
  <Card
