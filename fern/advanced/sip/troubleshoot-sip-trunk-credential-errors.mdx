...
Ask your SIP provider whether the Vapi SBC IP addresses for your region are on their allowlist:
...
Ask your SIP provider to add the Vapi SBC IP addresses for your region to their allowlist:

| Region | IP address | Netmask |
| --- | --- | --- |
