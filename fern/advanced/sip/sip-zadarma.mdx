...
- Enter the address for your Vapi region: `YOUR_VIRTUAL_NUMBER@sip.vapi.ai` for US or `YOUR_VIRTUAL_NUMBER@sip.eu.vapi.ai` for EU. Replace `YOUR_VIRTUAL_NUMBER` with your number in international format.
- Click **Save**.
