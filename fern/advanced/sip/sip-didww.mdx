...
<Steps>
  ...
  <Step title="Configure the required trunk fields">
    ...
    <Frame caption="Required DIDWW inbound SIP trunk settings for Vapi.">
      <img src="../../static/images/sip/sip-didww-inbound-general.png" />
    </Frame>
  </Step>
  ...
  <Step title="Enable call transfer signaling">
    ...
    <Frame caption="Allow at least one SIP transfer on the inbound trunk.">
      <img src="../../static/images/sip/sip-didww-inbound-transfer-signaling.png" />
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Configure authentication and allowed IPs">
    ...
    <Frame caption="Allow Vapi and DIDWW signaling addresses on the outbound trunk.">
      <img src="../../static/images/sip/sip-didww-outbound-allowlist.png" />
    </Frame>
  ...
  <Step title="Copy the outbound credentials">
    ...
    <Frame caption="Open and copy the DIDWW outbound trunk credentials.">
      <img src="../../static/images/sip/sip-didww-outbound-credentials.png" />
    </Frame>
  </Step>
  ...
  <Step title="Authorize transfers on the inbound trunk">
    ...
    <Frame caption="Reuse the outbound credentials for authenticated SIP REFER transfers.">
      <img src="../../static/images/sip/sip-didww-inbound-authorization.png" />
    </Frame>
...
<Tabs>
  <Tab title="UI" language="ui">
    In Vapi, go to **Organization Settings → Integrations → SIP Trunk** and click **Configure New SIP Trunk**.
    ...
    <Frame caption="Configure the DIDWW gateway for outbound calls.">
      <img src="../../static/images/sip/sip-didww-outbound-gateway.png" />
    </Frame>
    ...
    <Frame caption="Add the DIDWW outbound trunk credentials.">
      <img src="../../static/images/sip/sip-didww-authentication.png" />
    </Frame>
  </Tab>
...
<Tabs>
  <Tab title="UI" language="ui">
    ...
    <Frame caption="Create one inbound gateway for each DIDWW signaling IP.">
      <img src="../../static/images/sip/sip-didww-vapi-inbound-gateways.png" />
    </Frame>
    ...
    <Frame caption="Add the DIDWW credentials to the Vapi inbound trunk.">
      <img src="../../static/images/sip/sip-didww-vapi-inbound-authentication.png" />
    </Frame>
  </Tab>
...
<Tabs>
  <Tab title="UI" language="ui">
    ...
    3. Set **SIP URI** to `sip:+E164_NUMBER@OUTBOUND_ENDPOINT`, for example `sip:+1234567890@fra.eu.out.didww.com`.
    ...
    <Frame caption="Configure the DIDWW SIP transfer destination.">
      <img src="../../static/images/sip/sip-didww-transfer-destination.png" />
    </Frame>
  </Tab>
    ...
    curl -X POST https://api.vapi.ai/tool \
      ...
      -d '{
        ...
        "destinations": [
          {
            "type": "sip",
            "sipUri": "sip:+1234567890@YOUR_DIDWW_OUTBOUND_ENDPOINT",
...
<Tabs>
  <Tab title="UI" language="ui">
    ...
    <Frame caption="Add the transfer tool to the Vapi assistant.">
      <img src="../../static/images/sip/sip-didww-assistant-tool.png" />
    </Frame>
  </Tab>
...
[Purchase or select a DIDWW number, assign the inbound trunk, and import the number into Vapi](/phone-numbers/didww).
