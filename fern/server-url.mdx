...
slug: server-url
description: Set up server URLs so your application receives Vapi call events like status updates, transcripts, function calls, and end-of-call reports, and responds.
---
