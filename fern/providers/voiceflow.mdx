...
description: Connect Vapi with Voiceflow by hosting a proxy that routes Voiceflow requests to Vapi's text completion API and returns responses to your Voiceflow agent.
---
