...
description: Connect Vapi agents to GoHighLevel with Sympana Connector, a managed automation layer for outbound sequences, inbound routing, and CRM syncing inside GHL.
---
