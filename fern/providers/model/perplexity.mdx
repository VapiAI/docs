...
Set `model.provider` to `perplexity-ai`. Vapi doesn't maintain a preset model list for Perplexity — set `model.model` to a model ID available through the Perplexity Sonar API.
