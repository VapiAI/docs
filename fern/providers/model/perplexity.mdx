---
title: Perplexity
subtitle: Use a Perplexity model as the language model for your Vapi voice agent.
description: Connect Perplexity to Vapi and configure a model served by your Perplexity account as your assistant's language model.
...
You can use Perplexity through Vapi's default integration, or use your own Perplexity account by connecting it in [Integrations](/providers/integrations).
...
curl -X PATCH "https://api.vapi.ai/assistant/ASSISTANT_ID" \
  ...
  -d '{
    "model": { "provider": "perplexity-ai", "model": "YOUR_MODEL" }
  }'
```

For additional API configuration options, review the [`PerplexityAIModel` fields](/api-reference/assistants/create#request.body.model.PerplexityAIModel) in the Create Assistant API reference.

## Related

<CardGroup cols={2}>
  <Card title="Perplexity Sonar models" icon="arrow-up-right-from-square" href="https://docs.perplexity.ai/api-reference/sonar-post">
