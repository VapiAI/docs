...
Set `model.provider` to `together-ai`. Vapi doesn't maintain a preset model list for Together AI — set `model.model` to any model your Together AI account serves.
