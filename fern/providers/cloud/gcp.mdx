...
description: Store Vapi call recordings in Google Cloud Storage by configuring your GCP credential and bucket in Cloud Providers, uploading recordings when a call ends.
---
