...
description: Store Vapi call recordings in Cloudflare R2 by configuring your R2 credential and bucket in Cloud Providers, uploading recordings when each conversation ends.
---
