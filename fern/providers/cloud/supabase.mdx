...
description: Store Vapi call recordings in Supabase Storage by configuring your Supabase credential and bucket in Cloud Providers, uploading recordings when a call ends.
---
