...
Vapi supports text-to-speech (TTS) voices from many providers. You choose a voice by setting the **provider** and **voiceId** on your assistant's **voice** configuration. See [**Create Assistant**](/api-reference/assistants/create) in the API reference.
