...
We're updating Vapi Voices. The following legacy voices are being phased out and will be retired on **March 1, 2026**:
...
The following Vapi voices are **not** being retired and remain available:
...
<AccordionGroup>
  <Accordion title="How were the replacement voices selected?">
    We used ElevenLabs' voice matching tool to find the most appropriate replacements for each legacy voice based on tone, style, and characteristics.
  </Accordion>
