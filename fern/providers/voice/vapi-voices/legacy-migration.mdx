...
<AccordionGroup>
  ...
  <Accordion title="How do I switch my voice now?">
    ...
    1. **Dashboard:** Go to your assistant settings and select a new voice from the dropdown. If the voice doesn't pop up, select "Add Voice ID Manually" and copy paste the voice ID provided in the table above.
