...
description: Integrate ChatDash with Vapi to give AI agent agencies a white-label dashboard with analytics, call logs, and Stripe billing using your Agent ID and API key.
---
