...
description: Integrate VoiceAIWrapper with Vapi to launch a white-label voice AI agency, adding client onboarding, billing, and campaign management on top of Vapi's APIs.
---
