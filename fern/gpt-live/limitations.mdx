...
Other tool types are unsupported. Expose external lookups through a Function tool or API Request tool. Carrier acceptance of a transfer doesn't establish that the destination answered.
