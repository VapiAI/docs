...
slug: rss-feed
description: Subscribe to Vapi's status RSS feed to track the latest incidents from Vapi and underlying providers, including how to add the feed in Slack.
---
