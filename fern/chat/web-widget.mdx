...
description: "Add Vapi's web widget to a website for voice and text conversations, configure its appearance and behavior, and meet usage-based chat access requirements."
