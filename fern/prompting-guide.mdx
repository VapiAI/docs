...
Always set an explicit `description` on transfer and end-call tools. If you leave them blank, the auto-generated description may bias the model against calling them. See [Built-in tools](/tools/default-tools) for details on transfer and end-call tools.
