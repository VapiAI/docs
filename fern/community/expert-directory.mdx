...
>
  <img
    className="card-img bg:white"
    noZoom
    src="https://blue-official-newt-770.mypinata.cloud/ipfs/QmWV75NPrr6yJvsoTLikYQ2xF5qV4jzsj6v9E5vzK3wff1"
  />
  <div className="card-content">
    <h3>Msquare Automation</h3>
    <p>
  We Help Businesses Transform Their Customer Interactions With AI-Powered Voice Assistants That Designed To Scale Inbound And Outbound Calls And Improve Customer Satisfaction Effortlessly.
  </p>
  </div>
</Card>
</div>
