...
description: Import a new or existing Twilio phone number into Vapi so your assistants can place and receive calls on it as you scale to other telephony providers.
---
