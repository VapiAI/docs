    ...
    <Steps>
      ...
      <Step title="Enter the DIDWW number">
        ...
        <Frame caption="Import the DIDWW number with the DIDWW SIP trunk credential.">
          <img src="../static/images/quickstart/phone/import-didww-number-dashboard.png" alt="Vapi Create Phone Number form with BYO SIP Trunk Number selected and the DIDWW Inbound Trunk credential chosen" />
        </Frame>
      </Step>
      ...
      <Step title="Assign an assistant">
        ...
        <Frame caption="Assign an assistant to handle inbound calls to the DIDWW number.">
          <img src="../static/images/quickstart/phone/didww-number-assign-assistant.png" alt="Vapi phone number Inbound Settings with an assistant selected to handle inbound calls" />
        </Frame>
      </Step>
    </Steps>
  </Tab>
