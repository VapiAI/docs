...
<Steps>
  <Step title="Access the Dashboard">
    Open [**Logs → Calls**](https://dashboard.vapi.ai/logs)
  </Step>
...
OS: macOS 14.1
Issue: Save button becomes unresponsive after adding Function tools
Steps to reproduce:
1. Navigate to assistant creation page
2. Add 3+ Function tools
...
<Steps>
  <Step title="Access Organization Settings">
    Go to [https://dashboard.vapi.ai/settings/organization](https://dashboard.vapi.ai/settings/organization)
  </Step>
