...
Usage only and your optional Success Package determine the concurrency included with your subscription. You can purchase concurrent call line add-ons for more capacity. See [Buy capacity add-ons](/billing/manage-packages-and-add-ons#buy-capacity-add-ons). The Dashboard shows when the additional capacity takes effect before you confirm the purchase.
