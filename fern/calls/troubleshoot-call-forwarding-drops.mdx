...
<CardGroup cols={2}>
  ...
  <Card title="Blind transfer" icon="fa-light fa-phone" href="/tools/transfer-call/blind-transfer">
    Connect a caller immediately or add a summary to a SIP header.
  </Card>
  <Card title="Warm transfer" icon="fa-light fa-comments" href="/tools/transfer-call/warm-transfer">
    Introduce a caller with a message, summary, or TwiML.
  </Card>
  <Card title="Call ended reasons" icon="fa-light fa-circle-info" href="/calls/call-ended-reason">
    Look up transfer-related ended reasons and error codes.
  </Card>
</CardGroup>
