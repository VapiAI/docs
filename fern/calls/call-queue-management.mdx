...
<Note>
You'll need to know your subscription's concurrency limit. See [Pricing and Success Packages](/billing/pricing-and-success-packages#whats-included) for the concurrency included with the Usage plan and each Success Package.
</Note>
...
- **[Scaling Considerations](/calls/call-concurrency):** Plan, monitor, and scale simultaneous calls for high-volume deployments
