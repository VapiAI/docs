...
<Steps>
  ...
  <Step title="Open Voicemail Detection">
    Select the **Advanced** tab, then locate **Voicemail Detection**.
  </Step>

  <Step title="Choose a detection provider">
    Under **Voicemail Detection Provider**, choose **Off**, **Vapi (Recommended)**, **Google**, **OpenAI**, or **Twilio**.
  </Step>

  <Step title="Configure detection timing">
    For **Vapi (Recommended)**, **Google**, or **OpenAI**, set **Initial Detection Delay**, **Detection Retry Interval**, **Max Detection Retries**, and **Max Voicemail Message Wait**. **Twilio** does not expose additional tuning controls in the Dashboard.
  </Step>

  <Step title="Add a voicemail message">
    Locate **Messaging**, then enter the message the assistant should leave in **Voicemail Message**.
  </Step>
...
<Frame caption="Choose a voicemail detection provider and configure the initial delay.">
  <img src="../static/images/calls/voicemail-detection/voicemail-detection-provider-dashboard.png" />
</Frame>

<Frame caption="Configure the voicemail detection interval, retry limit, and message wait time.">
  <img src="../static/images/calls/voicemail-detection/voicemail-detection-tuning-dashboard.png" />
</Frame>
