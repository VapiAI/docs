  ...
  <Tab title="Dashboard">
    <Steps>
      ...
      <Step title="Create a free Vapi number">
        ...
        <Warning>
          Free Vapi phone numbers support US area codes only. The Usage plan includes one free number; higher Success Packages include more. For international use, import a number from another provider.
        </Warning>
      </Step>
