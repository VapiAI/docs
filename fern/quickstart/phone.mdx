...
description: Make your first Vapi phone call in minutes, creating a voice agent in the Dashboard or programmatically and talking to it over the phone.
---
  ...
  <Tab title="Dashboard">
    <Steps>
      ...
      <Step title="Create a free Vapi number">
        ...
        <Warning>
          Free Vapi phone numbers support US area codes only. You get one free number, and your Success Package may include more. For international use, import a number from another provider.
        </Warning>
      </Step>
