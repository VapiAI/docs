...
<Tip>
For the best developer experience, use the **Cursor code editor** while following this quickstart. Cursor offers AI-assisted coding and pairs well with our multi-language examples. Get it from [cursor.com](https://cursor.com/).
</Tip>
