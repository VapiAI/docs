...
description: Get started with Vapi, the developer platform for building voice AI agents that make and receive phone calls, handling the infrastructure so you can build.
---
