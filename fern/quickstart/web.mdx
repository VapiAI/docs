...
slug: quickstart/web
description: Build voice interfaces and backend integrations with Vapi's Web and Server SDKs, covering client-side voice apps and server-side call management.
---
...
- **Add tools:** Connect your voice agents to external APIs and databases with [function tools](/tools/custom-tools)
