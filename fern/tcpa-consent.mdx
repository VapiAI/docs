...
slug: tcpa-consent
description: Understand TCPA consent requirements for outbound Vapi calls, including prior express written consent for marketing and prior express consent for other calls.
---
