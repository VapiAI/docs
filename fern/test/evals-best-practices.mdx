...
description: Choose Eval checkpoints, give a decision only the context it needs, test both sides of each boundary, and pick the simplest judge that proves the behavior.
