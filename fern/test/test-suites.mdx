...
description: Run end-to-end automated tests on Vapi voice agents with Test Suites, now being replaced by Simulations as the more powerful way to test your agents.
---
