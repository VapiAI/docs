...
description: How Vapi handles personal data under GDPR, covering data processing, legal bases, data subject rights, and the security measures protecting user data.
---
