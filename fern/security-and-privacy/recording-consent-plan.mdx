...
<Steps>
  <Step title="Configure Your Assistant">
    ...
    <Tabs>
      <Tab title="Dashboard">
        1. Open the [Dashboard](https://dashboard.vapi.ai/). Select **Assistants**, then select an assistant.
        2. Select the **Advanced** tab.
        3. In the **Compliance** section, locate **Recording Consent Plan**.
...
- **[Built-in tools](/tools/default-tools)** - Transfer calls and end calls
