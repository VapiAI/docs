...
<Steps>
  <Step title="Confirm eligibility">
    HIPAA is available as a paid add-on for your subscription. See [Buy compliance and data add-ons](/billing/manage-packages-and-add-ons#buy-compliance-and-data-add-ons) to add it.
