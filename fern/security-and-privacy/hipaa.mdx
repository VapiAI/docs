...
<Steps>
  <Step title="Confirm eligibility">
    HIPAA is available as a paid compliance add-on with Usage only or any Success Package. It is charged for each organization. See [Buy compliance and data add-ons](/billing/manage-packages-and-add-ons#buy-compliance-and-data-add-ons) to add it.
