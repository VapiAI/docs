...
<Steps>
  <Step title="Confirm eligibility">
    HIPAA is available as a paid compliance add-on. Availability can depend on your Success Package and billing arrangement. See [Buy compliance and data add-ons](/billing/manage-packages-and-add-ons#buy-compliance-and-data-add-ons) to add it.
  ...
  <Step title="Enable HIPAA mode in the Dashboard">
    Enable **HIPAA compliance** from your compliance and data add-ons, entering the BAA recipient's name and organization when prompted. See [Buy compliance and data add-ons](/billing/manage-packages-and-add-ons#buy-compliance-and-data-add-ons) for the purchase steps. HIPAA is an organization-level setting: it applies to every assistant in your organization, with no per-assistant exception, and it cannot be enabled through the API.
