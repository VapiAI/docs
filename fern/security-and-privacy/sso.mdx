...
<Note>
SSO is available on the **Premier** plan. To enable it, [contact sales](/billing/pricing-and-success-packages#contact-sales).
</Note>
...
To enable SSO or ask about configuration, [contact sales](/billing/pricing-and-success-packages#contact-sales).
