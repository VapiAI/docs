...
description: Let your team sign in to Vapi through your identity provider with SAML or OIDC, an enterprise feature supporting Google Workspace, Microsoft Entra ID, and Okta.
---

<Note>
SSO is available as a custom capability with the **Premier** Success Package. To discuss adding SSO, [contact our sales team about Premier](/billing/pricing-and-success-packages#buy-a-success-package).
</Note>
...
To enable SSO or ask about configuration, [contact our sales team about Premier](/billing/pricing-and-success-packages#buy-a-success-package). If you already have Premier, contact your account team.
