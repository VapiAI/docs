...
<Warning>
Never expose a private API key in browser or mobile app code, logs, screenshots, or a source-code repository. Store private keys in a server-side secret manager or environment variable.
</Warning>
