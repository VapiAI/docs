...
description: Keep Vapi assistant configs and API keys on your backend by routing Web SDK calls through a proxy server that maps frontend data to Vapi API calls.
---
