...
<Warning>
Free Vapi phone numbers are only available for US national use and cannot make outbound calls. The Usage plan includes one free Vapi number, which you can request without adding a payment method. Higher Success Packages include more free numbers; see [Pricing and Success Packages](/billing/pricing-and-success-packages).
</Warning>
