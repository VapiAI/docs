...
<Warning>
Free Vapi phone numbers are only available for US national use and cannot make outbound calls. You can request a free Vapi number without adding a payment method.
</Warning>
