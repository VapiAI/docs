...
<Warning>
Free Vapi phone numbers are only available for US national use. You can only create up to 5 free numbers per account. You may request the first free number without adding a payment method. To add additional Vapi phone numbers, a saved payment method is required.
</Warning>
