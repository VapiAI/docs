...
slug: phone-calling
description: Create and configure phone numbers in Vapi to place and receive calls, using free US numbers or imported Twilio numbers for international and custom use.
---

## Overview

<Warning>
Free Vapi phone numbers are only available for US national use and cannot make outbound calls. You get one free Vapi number, which you can request without adding a payment method, and your Success Package may include more. See [Pricing and Success Packages](/billing/pricing-and-success-packages#whats-included).
</Warning>
