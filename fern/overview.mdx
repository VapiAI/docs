...
<Tip>
We recommend using the **Cursor code editor** when working through these docs and examples. Cursor provides AI-assisted editing and works great with JavaScript, TypeScript, and Python projects. Download it at [cursor.com](https://cursor.com/).
</Tip>
