...
<Steps>
  ...
  <Step title="Select your custom voice">
    Open an assistant and open **Voice Settings**. Choose **Cartesia** as the provider and select your voice, or switch to **Custom Voice ID** and paste your Cartesia voice ID.
  </Step>
</Steps>
