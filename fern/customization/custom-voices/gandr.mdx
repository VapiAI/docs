...
<Note>A Gandr account and API key are required. The free key starts at 100,000 tokens, no card.</Note>
...
Gandr is $10 per million tokens, or $150 a month for an unmetered stream (one connection held open around the clock). The free key carries 100,000 tokens with no card.
