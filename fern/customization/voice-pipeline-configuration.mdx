...
<Tabs>
  ...
  <Tab title="Multilingual">
    ...
    When using `flux-general-multi`, omit or leave `language` unset to enable automatic language detection.
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Multilingual">
    ...
    **Optimized for:** Multilingual conversations where Deepgram is set as transcriber. Omit `language` to enable automatic language detection.
  </Tab>
</Tabs>
