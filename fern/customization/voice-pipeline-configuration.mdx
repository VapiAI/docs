...
<Steps>
  ...
  <Step title="Open the speaking plans">
    Select the **Advanced** tab, then locate **Start Speaking Plan** and **Stop Speaking Plan**.
  </Step>

  <Step title="Configure when the assistant starts speaking">
    In **Start Speaking Plan**, set **Wait Seconds**. Choose **Off**, **Vapi**, or **LiveKit** under **Smart Endpointing**, then set **On Punctuation Seconds**, **On No Punctuation Seconds**, and **On Number Seconds**.
  </Step>

  <Step title="Configure when the assistant stops speaking">
    In **Stop Speaking Plan**, set **Number of Words**, **Voice Seconds**, and **Back Off Seconds**.
  </Step>
...
<Frame caption="Configure when the assistant starts speaking.">
  <img src="../static/images/customization/voice-pipeline-configuration/start-speaking-plan-dashboard.png" />
</Frame>

<Frame caption="Configure how the assistant responds to interruptions.">
  <img src="../static/images/customization/voice-pipeline-configuration/stop-speaking-plan-dashboard.png" />
</Frame>
...
<Tabs>
  ...
  <Tab title="Providers">
    ...
    **Audio-text based providers:**
    ...
    - **assembly**: Transcriber with built-in end-of-turn detection (English, multilingual, and Universal 3.5 Pro models)
...
- **Assembly**: Best used when Assembly is already your transcriber provider, with integrated end-of-turn detection
