...
description: Set Vapi server URLs at multiple levels to handle call events, and learn how priority decides which URL receives a given event.
---
...
- **Function tool:** Function tools can have their own server URL
...
<AccordionGroup>
  ...
  <Accordion title="Function tool" icon="function" iconType="solid">
    The most granular server URL can be set on a Function tool. This can be done either in the Dashboard or via code.
    ...
    <AccordionGroup>
      <Accordion title="In the Dashboard" icon="browsers" iconType="solid">
        ...
        <Steps>
          <Step title="Create a Function tool">
            Open the [Dashboard](https://dashboard.vapi.ai/tools). Select **Tools**, select **Create Tool**, then select **Function tool**.
          </Step>
          <Step title="Configure the server URL">
          ...
          <Step title="Save the Function tool">
            Select the **Saved** control at the top of the tool editor to save the configuration.
          </Step>
        </Steps>

        <Frame caption="Configure server settings for a Function tool.">
      ...
      <Accordion title="Via the API" icon="code" iconType="solid">
        ...
        You can configure server settings for Function tools during [tool creation](/api-reference/tools/create), [assistant creation](/api-reference/assistants/create-assistant), or updates.
...
1. **Function tool:** if a Function tool has a server URL, the tool request will be sent to that URL
