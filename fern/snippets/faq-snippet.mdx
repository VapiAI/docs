...
See the [Vapi pricing page](https://vapi.ai/pricing) for current rates and [Pricing and Success Packages](/billing/pricing-and-success-packages) to understand Usage only, optional Success Packages, and add-ons.
