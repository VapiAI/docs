...
See the [Vapi pricing page](https://vapi.ai/pricing) for current rates and [Pricing and Success Packages](/billing/pricing-and-success-packages) to understand the Usage plan, optional Success Packages, and add-ons.
...
Yes, volume pricing is available as you scale. See the [Vapi pricing page](https://vapi.ai/pricing) for details.
