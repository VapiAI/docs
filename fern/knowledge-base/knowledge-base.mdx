...
subtitle: >-
  ...
  assistants
slug: knowledge-base
description: Create and integrate knowledge bases into Vapi voice agents so they retrieve information from your documents to answer questions accurately during a call.
---

A knowledge base is a set of documents an assistant can search during a call to answer questions it was not given in its prompt. This section covers creating a knowledge base, querying it with the query tool, and replacing Vapi's built-in retrieval with a server of your own.
