...
2. **Recording Download URLs in the End of Call Report**: The end of call report now includes short-lived presigned download URLs for your [call recordings and logs](/assistants/retrieve-call-artifacts), so you can download them directly.
