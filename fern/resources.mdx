...
slug: resources
description: Explore the Vapi ecosystem in one place, with links to the CLI, client and server SDKs, code examples, MCP server, API reference, and community resources.
---
...
<tbody>
<tr><td>Vapi CLI</td><td><a href="/cli">Overview</a> · <a target="_blank" href="https://github.com/VapiAI/cli">GitHub</a> · <a href="/cli/init">Project Integration</a> · <a href="/cli/mcp">MCP Setup</a> · <a href="/cli/webhook">Webhook Testing</a></td></tr>
