...
Changing any component moves your assistant to **Customized**. Only the changed component overrides the preset. Your assistant keeps every other preset setting. Benchmark data updates to match the new configuration.
...
<Steps>
  ...
  <Step title="Choose a preset">
    Choose an option under **Model Presets**. The transcriber, model, voice, and benchmark totals update to match the preset.
  </Step>
  <Step title="Customize components if needed">
    Click the pencil icon on the transcriber, model, or voice panel. Use the settings panel to change the provider or component. Your assistant moves to **Customized**. Benchmark data updates to reflect your choices.
  </Step>
...
The option you chose is highlighted under **Model Presets**. Confirm the component panels and benchmark totals match the preset or your custom configuration.

## Related

<CardGroup cols={2}>
  <Card title="Model Intelligence for transcribers, models, and voices" href="/assistants/model-intelligence/overview">
    Learn how presets and benchmark data help you choose components.
  </Card>
