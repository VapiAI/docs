...
The transfer destination type follows the destinations described in the [transfer call tool guide](/tools/transfer-call#choose-a-destination). See the [Create Tool API reference](/api-reference/tools/create) for the complete tool schema.
</Note>
