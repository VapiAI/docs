...
See [call concurrency](/calls/call-concurrency) to understand how capacity is shared. When the organization needs more simultaneous calls, [purchase additional call lines](/billing/manage-packages-and-add-ons#buy-capacity-add-ons) from the Dashboard.
