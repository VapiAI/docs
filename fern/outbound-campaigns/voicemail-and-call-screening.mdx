...
Call screeners can introduce longer pauses and fragmented speech before a person joins. Use [smart endpointing](/customization/speech-configuration) and set [Silence Timeout](/documentation/assistants/conversation-behavior/call-timeout-settings) to 45–60 seconds so the assistant can wait through that handoff without timing out prematurely.
...
<CardGroup cols={2}>
  ...
  <Card title="Configure call timeouts" icon="clock" href="/documentation/assistants/conversation-behavior/call-timeout-settings">
