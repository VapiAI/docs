...
description: Build a custom analytics dashboard with Vapi Boards, adding charts, time-range filters, and calculated metrics in the Dashboard to track call performance.
---
