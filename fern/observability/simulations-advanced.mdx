...
- **Tool**: Select one of the [**tools**](/tools) configured on the assistant or squad. Only its configured tools, including [**function tools**](/tools/custom-tools), can be mocked.
