...
description: Create a Vapi scorecard that grades completed calls from their structured outputs, awarding points per metric and filtering calls by score via the API.
---
