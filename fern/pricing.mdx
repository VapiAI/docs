...
<CardGroup cols={2}>
  <Card title="Developer" icon="code" href="https://dashboard.vapi.ai/billing">
    **Pay-as-you-go**
  ...
  <Card title="Business" icon="building" href="https://dashboard.vapi.ai/billing">
    **Custom pricing**
...
View detailed pricing in your [Vapi Dashboard](https://dashboard.vapi.ai/billing).
...
[Contact our sales team](https://vapi.ai/contact) for enterprise pricing.
...
- [View detailed usage](https://dashboard.vapi.ai/billing) in your dashboard
- [Contact sales](https://vapi.ai/contact) for enterprise needs
