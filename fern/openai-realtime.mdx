...
<Note>
  The Realtime API is currently in beta, and not recommended for production use by OpenAI. Advanced functionality is currently limited with the latest voices Ash, Ballad, Coral, Sage and Verse. We're excited to have you try this new feature and welcome your [feedback](https://discord.com/invite/pUFNcf2WmH) as we continue to refine and improve the experience.
</Note>
