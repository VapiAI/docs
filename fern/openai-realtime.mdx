...
<Tip>
  The `gpt-realtime-2025-08-28` model is production-ready with full feature support including structured outputs and the Responses API.
</Tip>
...
|-------|---------|----------|--------------|
| `gpt-realtime-2025-08-28` | **Production** | Production workloads | Full feature support, structured outputs, Responses API |
...
Different realtime models support different features:

| Feature | gpt-4o-realtime-preview | gpt-4o-mini-realtime-preview | gpt-realtime-2025-08-28 |
|---------|------------------------|------------------------------|------------------------|
| Function Calling | ✅ | ✅ | ✅ |
| Parallel Functions | ✅ | ✅ | ✅ |
| Structured Output | ❌ | ❌ | ✅ |
