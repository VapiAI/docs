...
description: Configure fallback voices in Vapi that activate automatically when your primary voice provider fails, switching through your ordered list to keep calls live.
---
