...
<Tabs>
  ...
  <Tab title="Remote (SSE, deprecated)">
...
<CardGroup cols={2}>
  <Card title="Need help?" icon="question-circle" href="https://discord.gg/v5Ee6FhAZt">
    Ask other developers about the MCP server in the Vapi Discord community.
  </Card>
