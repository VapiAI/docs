...
Organization capacity is the number of organizations that a subscription can contain. Usage only and each Success Package include an organization allowance.
...
If no capacity remains, upgrade your Success Package before creating another organization.
