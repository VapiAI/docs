...
<Steps>
  ...
  <Step title="Enter the details">
    ...
    <Frame caption="Account and subscription details blurred for privacy.">
      <img src="../static/images/billing/billing-new-organization.png" alt="New organization dialog with name, admin email, and subscription fields" />
    </Frame>
  </Step>
  <Step title="Create">
