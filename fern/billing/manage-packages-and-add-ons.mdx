...
Available add-ons can be used with Usage only or any Success Package. Purchase methods depend on your billing arrangement.
...
<Steps>
  ...
  <Step title="Set the amounts">
    Set the number of additional call lines you want.
  </Step>
  <Step title="Review and pay">
...
Compliance and data add-ons change how Vapi handles data for a subscription. Options can include HIPAA compliance and extended data retention. HIPAA is available with any package and is charged for each organization.
