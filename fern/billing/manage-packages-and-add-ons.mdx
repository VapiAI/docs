...
description: Learn how to upgrade, downgrade, or remove a Success Package, and buy concurrent call line, organization, HIPAA, and data retention add-ons in the Vapi Dashboard.
slug: billing/manage-packages-and-add-ons
---

Usage-based billing remains active when you add, change, or remove a Success Package. You can also purchase add-ons that increase specific capabilities without changing your Success Package.
...
<Steps>
  <Step title="Open Billing & Payment">
    In the [Vapi Dashboard](https://dashboard.vapi.ai), open **Billing & Payment**. Your active plan appears in the **Success package** field.
  </Step>
  <Step title="Open Packages & add-ons">
    Select the **Packages & add-ons** tab. Your current package is marked **Current package**, with its included limits, support, and compliance options listed.

    <Frame>
      <img src="../static/images/billing/billing-packages-usage-plan.png" alt="Packages tab showing Usage as the current package and its included limits" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Review and pay">
    ...
    <Frame caption="Subscription details blurred for privacy.">
      <img src="../static/images/billing/billing-core-purchase-review.png" alt="Purchase Core review showing estimated charges and changes to package limits" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Start the downgrade">
    In **Packages & add-ons**, select a lower Success Package, or remove your current package to continue with **Usage only**.
  </Step>
...
- **Additional organizations** in the subscription, beyond the number your package includes.
...
Compliance and data add-ons change how Vapi handles data for a subscription. Options can include HIPAA compliance and extended data retention. HIPAA is available with any package.
...
<Steps>
  ...
  <Step title="Choose the add-ons">
    Enable **HIPAA compliance** and enter the signatory name and legal entity name. Vapi emails a Business Associate Agreement (BAA) to the recipient you enter. You can also enable **extended data retention**.
  </Step>
  <Step title="Review and pay">
...
The Dashboard shows the payment method, amount due, and renewal details before you confirm a purchase. For invoiced subscriptions, including Premier, contact your account team. Purchase methods depend on your billing arrangement.
