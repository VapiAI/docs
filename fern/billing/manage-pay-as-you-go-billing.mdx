...
slug: billing/manage-pay-as-you-go-billing
---

<Note>
This page describes the previous **Billing & Add-Ons** experience. If your Dashboard shows **Billing & Payment** with a **Packages & add-ons** tab, see [Manage billing and credits](/billing/manage-billing-and-credits) instead.
</Note>
...
<Steps>
  ...
  <Step title="Buy credits">
    At the top of the Billing page, select **Buy credits**. In **Purchase Vapi credits**, enter at least the minimum amount in **Amount to purchase**, then select **Purchase**.
  ...
  <Step title="Optional: Configure auto reload">
    In **Payment method**, turn on **Enable auto reload**. Enter at least the minimum amount in **Amount to reload**, then enter the balance that should trigger the purchase in **When threshold reaches**.
