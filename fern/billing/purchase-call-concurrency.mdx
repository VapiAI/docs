...
description: "Purchase call concurrency from Billing & Add-Ons to increase the number of simultaneous calls available to your Vapi organization. See Vapi pricing for rates."
slug: billing/purchase-call-concurrency
---

<Note>
This page describes the previous **Billing & Add-Ons** experience. If your Dashboard shows **Packages & add-ons**, see [Manage Success Packages and add-ons](/billing/manage-packages-and-add-ons) instead.
</Note>
...
<Card title="Vapi pricing" href="https://vapi.ai/pricing">
  See current call concurrency and add-on rates on the official pricing page.
</Card>
