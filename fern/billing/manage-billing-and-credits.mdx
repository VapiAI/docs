...
<Steps>
  <Step title="Open the Billing page">
    ...
    <Frame caption="Subscription details blurred for privacy.">
      <img src="../static/images/billing/billing-payments-overview.png" alt="Billing and payment page with the Payments tab selected, payment method status, and auto-reload status" />
    </Frame>
  </Step>
  <Step title="Manage payment methods">
    ...
    <Frame>
      <img src="../static/images/billing/billing-add-payment-method.png" alt="Manage payment methods dialog with card details and auto-reload controls" />
    </Frame>
  </Step>
