...
<Note>
If your Dashboard shows **Settings → Billing & Add-Ons** instead of **Billing & Payment**, you are on the previous experience. See [Manage pay-as-you-go billing and credits](/billing/manage-pay-as-you-go-billing).
</Note>
