...
<CardGroup cols={2}>
  ...
  <Card title="Lookup-based transfers" icon="phone-arrow-right" href="/calls/transfer-calls-with-api-lookup">
    Look up a caller's branch, then transfer them with a Transfer Call tool.
  </Card>
</CardGroup>
