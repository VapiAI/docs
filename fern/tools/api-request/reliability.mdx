...
For the complete field definitions, see the [Create Tool](/api-reference/tools/create) and [Update Tool](/api-reference/tools/update) API references. To diagnose failed tool calls, see [Troubleshoot tools](/tools/custom-tools-troubleshooting).
