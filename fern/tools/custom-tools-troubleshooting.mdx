---
title: Troubleshoot tools
description: "Troubleshoot Function tool integrations in Vapi, including trigger failures, response errors, token truncation, multiple tool responses, and async behavior."
slug: tools/custom-tools-troubleshooting
---

## Overview

Troubleshoot and fix common issues with Function tool integrations in your Vapi assistants.
...
per-turn token budget as speech. Raise [`maxTokens` on the assistant's `model`](/api-reference/assistants/create#request.body.model),
