...
Don’t feel overwhelmed by all of this functionality (& unfamiliar UI), we will be walking through the core necessities you need to get up and running in this guide.
...
We're going to walk-through step-by-step how you'd create create this assistant from scratch in the dashboard:
