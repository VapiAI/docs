...
```javascript
vapi.start(assistantCreateOptions);
```
...
1. **create an assistant:** Vapi will create a new assistant on our behalf (conforming to the [Create Assistant endpoint](/api-reference/assistants/create-assistant) options)
