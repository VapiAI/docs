...
Now will call `.start()` & pass the pre-made assistant ID in:

```javascript
vapi.start("79f3XXXX-XXXX-XXXX-XXXX-XXXXXXXXce48");
```

And this will have the same effect as what we did inline before, we just broke up the steps.
