...
<CardGroup cols={2}>
  <Card title="Provider Keys" icon="key" href="/provider-keys">
    Add your API keys for other providers
  </Card>
  <Card title="Custom LLM URL" icon="brain" href="/custom-llm">
  ...
  <Card title="Persistent / Temporary Assistants" href="/persistent_assistants" icon="database">
