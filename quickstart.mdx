...
<Info>The idea is to perform each phase in realtime (sensitive down to 50-100ms level) — ideally the whole flow [voice-to-voice](/glossary#voice-to-voice) clocks in at \<500-700ms.</Info>
...
To demonstrate these core concepts & how they show up in Vapi, we'll be implementing a simple
