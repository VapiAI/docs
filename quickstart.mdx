...
<Frame caption="We will base our basic walkthroughs on this core order-taking agent example.">
  <img src="/static/graphics/quickstart/vapis-pizzeria.png" />
</Frame>

We will walk through the same quickstart demo with every major way you can interface with Vapi’s systems:
