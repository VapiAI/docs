...
#### Starting Calls with an Assistant ID

If you already have an assistant that you created (either via the Dashboard or [the API](/api-reference/assistants/create-assistant))

You can start the web call with an assistant ID
