...
<AccordionGroup>
  <Accordion title="Transcription Providers" icon="microphone" iconType="solid" defaultOpen={true}>
    <CardGroup cols={2}>
      <Card
        title="Deepgram"
  ...
  <Accordion title="Model Providers" icon="microchip" iconType="solid" defaultOpen={true}>
    <CardGroup cols={2}>
      <Card
        title="OpenAI"
  ...
  <Accordion title="Voice Providers" icon="person" iconType="solid" defaultOpen={true}>
    <CardGroup cols={3}>
      <Card
        title="ElevenLabs"
